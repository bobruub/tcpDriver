...
public class tcpProperties {
  ...
  public static final String ITERATIONS_COUNT_TAG = "Iterations";
  public static final String RAMPUP_COUNT_TAG = "RampUp";
  ...
  public tcpProperties(Element httpReceiverElement) {
    ...
    setCharSet(httpReceiverElement.getAttribute(CHARSET_TAG));
    setDefaultAction(httpReceiverElement.getAttribute(DEFAULT_ACTION));
    setIterations(httpReceiverElement.getAttribute(ITERATIONS_COUNT_TAG));
    setRampUp(httpReceiverElement.getAttribute(RAMPUP_COUNT_TAG));
